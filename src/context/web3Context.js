...
import { getRPCUrl, getWalletProviderName } from "../utils/helper";
import '../css/web3modal.css';
/**
...
const web3Modal = new Web3Modal({
    ...
    theme: {
        background: "#01010185", // Modal background color
        textColor: "#e0e0e0",  // Text color inside the modal
        borderRadius: "12px",  // Border radius for modal
        // mainColor: "#4caf50",  // Primary color (e.g., button color)
        // secondaryColor: "#ff5722", // Secondary color (e.g., hover color for buttons)
        // accentColor: "blue"
    },
    providerOptions: {
        walletconnect: {
            ...
            options: {
                infuraId: "0274f321441341edaba19fafa9e0c231", // Required
                rpc: {
        ...
        coinbasewallet: {
            ...
            options: {
                ...
                infuraId: "0274f321441341edaba19fafa9e0c231", // Required
                rpc: "https://mainnet.infura.io/v3/0274f321441341edaba19fafa9e0c231", // Optional if `infuraId` is provided; otherwise it's required
...
export const Web3ContextProvider = ({
    ...
    const _checkNetwork = (otherChainID) => {
        ...
        if (chainID !== otherChainID) {
            ...
            if (
                ...
                Object.keys(CHAINS).includes(otherChainID.toString())
            ) {
                setChainID(otherChainID);
                otherChainID === EnvHelper.getOtherChainID() ?
                    setUri(getMainnetURI()) :
                    setUri(getRPCUrl(otherChainID));
                return true;
            }
            return false;
        }
        ...
        try {
            ...
            if (!validNetwork) {
                ...
                return {
                    type: "error",
                    title: "Error",
                    detail: "Wrong network, Switch to Ethereum Network",
                };
            }
    ...
    const isMetamask = useMemo(
        () =>
            ...
            window.ethereum?.isMetaMask === true, [provider]
    );
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    style.innerHTML = `
        ...
        .web3modal__button:hover {
            background-color: #388e3c !important;
        }
        .web3modal__wallet:hover {
