...
const StakingModal = ({
    ...
    useEffect(() => {
        if (amount > balance && !maxpressed) setInsufficient(true);
    ...
    return (
        <Dialog open={open} onClose={() => setOpen(false)}>
            <DialogPanel>
                <DialogHeader>
                    <Box>{type === 1 ? "Stake in Pool" : "Unstake"}</Box>
                ...
                <DialogBody>
                    ...
                    >
                        ...
                        <Box fontWeight={"bold"}>LDR | LDR V2 LP</Box>
                    </Box>
                    <InputPanel mt={"12px"}>
                        <input
                            type="text"
                        ...
                        <Box mt={"8px"} textAlign={"right"}>
                            {Number(amount * price).toFixed(5)} USD
                        </Box>
                    </InputPanel>
                    {insufficient ? (
                        <Box
                    ...
                    <Box mt={"15px"} width={"calc(100% - 18px)"} ml={"12px"}>
                        <Slider
                            ...
                            onChange={(e, val) => {
                                ...
                                setAmount(Number((balance * val) / 100).toFixed(8));
                                setActive(0);
                            }}
                            color="primary"
                            size={"medium"}
                    ...
                    <Box
                        ...
                        marginLeft={
                            (amount / balance) * 100 > 97
                                ? sm
                                    ? `calc(100% - 32px)`
                                    : `calc(100% - 36px)`
                                : sm
                                    ? `calc((100% - 20px) / 100 * ${(amount / balance) * 100}) `
                                    : `calc((100% - 24px) / 100 * ${(amount / balance) * 100}) `
                        }
                    >
                        {Number(balance / 1 ? (amount / balance) * 100 : 0).toFixed(0)}%
                    </Box>
                    <SelectPanel mt={"14px"} active={active}>
                        <Box
                            onClick={() => {
                                setActive(1);
                                setAmount(Number(balance / 4).toFixed(8));
                                setMaxPressed(false);
                            }}
                        >
                            25%
                        ...
                        <Box
                            onClick={() => {
                                setActive(2);
                                setAmount(Number((balance * 2) / 4).toFixed(8));
                                setMaxPressed(false);
                            }}
                        >
                            50%
                        ...
                        <Box
                            onClick={() => {
                                setActive(3);
                                setAmount(Number((balance * 3) / 4).toFixed(8));
                                setMaxPressed(false);
                            }}
                        >
                            75%
                        ...
                        <Box
                            onClick={() => {
                                setActive(4);
                                setAmount(Number(balance).toFixed(8));
                                setMaxPressed(true);
                            }}
                        >
                            100%
                    ...
                    <Box mt={"32px"}>
                        <Button
                            ...
                            onClick={onClick}
                            disabled={pending || !(amount / 1) || insufficient}
                        >
                            Confirm
                        </Button>
                    </Box>
