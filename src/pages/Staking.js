  ...
  return (
    <>
      <StyledContainer>
        ...
        <PoolPanel display={"flex"} justifyContent={"center"} >
          {lockinfo.map((data, i) => {
            ...
            return (
              <Pool key={i}>
                <Box display={"flex"} justifyContent={"space-between"}>
                  ...
                  <Box width={xs ? "100%" : "100%"} px={"20px"} py={"0px"} display={{ xs: "none", sm: "none", md: "blcok", lg: "block" }}>
                    <HarvestBox
                      display={"flex"}
                    ...
                    >
                      <Box>
                        <Box fontSize={xs ? "12px" : "16px"}>LDR Earned</Box>
                        <Box
                    ...
                    >
                      <Box>
                        <Box fontSize={xs ? "12px" : "16px"}>LDR Staked</Box>
                        <Box
                          fontSize={xs ? "12px" : "16px"}
                          fontWeight={600}
                          mt={xs ? "-2px" : "2px"}
