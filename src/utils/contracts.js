...
export const getFarmContract = (chainID, signer) => {
  return getContract(FarmABI, GROVE_FARM[chainID], chainID, signer);
};
...
export const getstETHContract = (chainID, signer) => {
  return getContract(STETHABI, STETH[chainID], chainID, signer);
};

export const getLockContract = (chainID, signer) => {
  return getContract(LockABI, GROVE_LOCK[chainID], chainID, signer);
};

export const getLockContractOld = (chainID, signer) => {
  return getContract(LockABI, GROVE_LOCK_OLD[chainID], chainID, signer);
};
